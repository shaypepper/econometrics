...
#### 1. PUMS data using hypothesis tests (20 points)
...
#### 2. PUMS using proportions, tables (25 points)
...
#### 3. ATUS dataset crosstabs, marginal probabilities
...
#### 4. CEX data using conditionals, analysis (20 points)
...
#### 5. Some data? using hypothesis tests (25 points) 
...
#### 6. MENA data using conditionals, hypothesis tests  (30 points) 
...
#### 7. ATUS data, conditionals (20 points) 
...
#### 8. ATUS data using conditional means, cofidence intervals, hypothesis tests
...
#### 7. Taxi data OLS, kNN, HT, CI (30 points)
...
#### 8. ATUS data using CI, OLS, kNN (30 points)
...
#### 9. CEX data using OLS, tables (30 points)
...
#### 10. CEX data using plots, tables, OLS kNN (25 points)
...
#### 11. ATUS data. 25pts using kNN, OLS, HT
